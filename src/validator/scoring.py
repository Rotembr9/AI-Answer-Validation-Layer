...
def contradiction_signals(
    ...
    urgent_scope_text = f"{q_norm} {a_norm}"
    urgent_in_scope = (
        (
            "urgent" in urgent_scope_text
            or "severity" in urgent_scope_text
            or "priority 1" in urgent_scope_text
            or re.search(r"\bp1\b", urgent_scope_text)
            or "critical" in urgent_scope_text
        )
