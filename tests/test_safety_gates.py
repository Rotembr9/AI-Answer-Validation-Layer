...
def test_p1_alias_wrong_urgent_window_never_supported() -> None:
    q = "How fast do P1 tickets get a response?"
...
def test_remote_no_approval_cap_understatement_never_supported() -> None:
...
if __name__ == "__main__":
    ...
    test_p1_alias_wrong_urgent_window_never_supported()
    test_closed_nonurgent_does_not_borrow_urgent_hours()
    test_remote_no_approval_cap_understatement_never_supported()
