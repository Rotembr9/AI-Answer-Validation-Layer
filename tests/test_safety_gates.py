...
def test_unrelated_exclusivity_does_not_downgrade_supported_answer() -> None:
...
if __name__ == "__main__":
    ...
    test_unrelated_exclusivity_does_not_downgrade_supported_answer()
    print("ok: safety gates and scoped exclusivity regressions passed")
