...
def test_unrelated_exclusivity_marker_does_not_downgrade_remote_answer() -> None:
    """The contractor exclusion line must not penalize unrelated remote-work facts."""
...
if __name__ == "__main__":
    ...
    test_unrelated_exclusivity_marker_does_not_downgrade_remote_answer()
    print("ok: safety gates and exclusivity scoping regressions passed")
