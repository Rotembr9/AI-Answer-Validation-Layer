...
def test_closed_nonurgent_with_urgent_window_never_supported() -> None:
    q = "How fast do nonurgent tickets get a first response?"
...
if __name__ == "__main__":
    ...
    test_closed_nonurgent_with_urgent_window_never_supported()
    test_correct_mixed_sla_remains_supported()
    print("ok: safety gates block unsafe SLA and exclusivity cases")
